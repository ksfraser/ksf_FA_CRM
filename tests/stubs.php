...
/**
 * Shared test stubs for ksf_FA_CRM.
 *
 * Provides FA globals (TB_PREF), a GLOBALS-backed fake database
 * (db_query/db_fetch_assoc/db_num_rows/db_insert_id/db_escape),
 * a translation stub, and a base hooks class for loading hooks.php in tests.
 *
 * @package ksf_FA_CRM
 * @since 1.0.0
 */
...
namespace {
    ...
    if (!function_exists('db_query')) {
         ...
         * INSERT sets the insert id, all other statements succeed.
         *
