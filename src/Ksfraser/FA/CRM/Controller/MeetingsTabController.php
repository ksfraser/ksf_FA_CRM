...
use Ksfraser\FA\CRM\Service\MeetingsService;

/**
 * MeetingsTabController — controller SRP for the CRM Meetings tab.
 *
 * PHP 7.3 compatible.
 *
 * @package ksf_FA_CRM
 ...
 */
class MeetingsTabController extends AbstractTabController
{
    /** @var MeetingsService */
    private $service;
    ...
    {
        return MeetingsService::getFieldMetadata();
    }
    ...
    protected function fkOptions(): array
    {
        return [
            ...
            'meeting_type' => MeetingsService::typeOptions(),
            'status'       => MeetingsService::statusOptions(),
            'priority'     => MeetingsService::priorityOptions(),
            'location_type'=> MeetingsService::locationOptions(),
        ];
    }
}