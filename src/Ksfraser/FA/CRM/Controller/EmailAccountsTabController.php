...
use Ksfraser\FA\CRM\Service\EmailAccountsService;

/**
 * EmailAccountsTabController — controller SRP for the CRM Email Accounts tab.
 *
 * PHP 7.3 compatible.
 *
 * @package ksf_FA_CRM
 ...
 */
class EmailAccountsTabController extends AbstractTabController
{
    ...
    public function __construct($context = null, array $options = [])
    {
        ...
        $this->service = new EmailAccountsService();
    }
    ...
    {
        return EmailAccountsService::getFieldMetadata();
    }
    ...
    {
        return [
            'encryption' => EmailAccountsService::encryptionOptions(),
        ];
    }
}