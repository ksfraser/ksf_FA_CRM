...
use Ksfraser\FA\CRM\Service\TagsService;

/**
 * TagsTabController — controller SRP for the CRM Tags tab.
 *
 * Wraps the FA core 0_tags table via TagsService. Delete skips tags still
 * referenced by tag_associations.
 *
 * PHP 7.3 compatible.
 *
 * @package ksf_FA_CRM
 ...
 */
class TagsTabController extends AbstractTabController
{
    /** @var TagsService */
    private $service;
    ...
    {
        return TagsService::getFieldMetadata();
    }
