...
class hooks_ksf_FA_CRM extends hooks {
    ...
    function install_access() {
        ...
        $security_areas['SA_ksf_FA_CRMVIEW'] = array(SS_ksf_FA_CRM | 1, _("View "));
        $security_areas['SA_ksf_FA_CRMMANAGE'] = array(SS_ksf_FA_CRM | 2, _("Manage "));
