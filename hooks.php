 ...
 * 
 * @package KsfFA_ksf_FA_CRM
 * @version 2.4.3
 */

define('SS_ksf_FA_CRM', 120 << 8);
...
class hooks_ksf_FA_CRM extends hooks {
    ...
    function install_access() {
        $security_sections[SS_ksf_FA_CRM] = _("");
        $security_areas['SA_ksf_FA_CRMVIEW'] = array(
            SS_ksf_FA_CRM | 1, 
            _("View ")
        );
        $security_areas['SA_ksf_FA_CRMMANAGE'] = array(
            SS_ksf_FA_CRM | 2, 
            _("Manage ")
        );
